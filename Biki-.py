# decoder by cobra linux command __Tools Owner Biki Mahamood
# https://github.com/biki404-cyber
# Python 3.11 ___WhatsApp 9957975493
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://m.me/bikiterabap"])
...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> +919957975493")
	subprocess.check_output(["am", "start", "https://wa.me/+919957975493"])
...
class Main:
	def __init__(self):
		...
		print ("""\033[0;92m888888b.  8888888 888    d8P  8888888 
...
\033[0;96m
 ...
 > \033[0;92mDEVELOPER     : Mr.BIKI
 > \033[0;95mFACEBOOK ID   : BIKI MAHAMOOD
 > \033[0;41mWHATSAPP      : +919957975493
 \033[0;96m> YOUTUBE       : BIKI WORLD
 > \033[0;97mWARNING       : DONT USE FOR ILLEGAL WORK     
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [BIKI] : %s/%s -> \033[0;92m [ BIKI-OK:%s ]- \033[0;93m[BIKI-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
